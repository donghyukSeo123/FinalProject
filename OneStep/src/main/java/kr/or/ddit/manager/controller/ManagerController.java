...
public class ManagerController {
	...
	//파일 다운로드 
		...
		@ResponseBody
		public String inviteCom(@RequestBody Map<String, Object> jsonObj,
				HttpServletRequest req,NotificationVO alarm) throws Exception {
		    ...
		    Object data = jsonObj2.get("data");
		    JSONObject jsonObj3 = (JSONObject) data;
		     
		    Object url = jsonObj3.get("url");
			...
			// 받는 사람
			alarm.setGetId(strMemId);
			// 경로 url
			alarm.setNotificationUrl(url+"");
			// 알림 내용
			alarm.setNotificationContent("화상 초대 코드를");
		...
		@ResponseBody
		public String inviteMem(@RequestBody Map<String, Object> jsonObj, HttpServletRequest req
